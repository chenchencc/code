...
public class HelloGeneratorClass implements Opcodes {
    ...
    public static byte[] generatorHelloClass() throws Exception {
        ...
        cw.visit(V1_8, ACC_PUBLIC + ACC_SUPER, "com/jason/asm/Hello", null, "java/lang/Object", null);
        ...
        }
        {
            ...
            mv.visitFrame(Opcodes.F_FULL, 8,
                    new Object[] { "com/jason/asm/Hello", Opcodes.INTEGER, "[Ljava/util/Map;",
            ...
            mv.visitLabel(l2);
            mv.visitFrame(Opcodes.F_FULL, 4, new Object[] { "com/jason/asm/Hello", Opcodes.INTEGER,
    ...
    public static void main3(String[] args) {
        try {
            ...
            Class<?> helloClass = myClassLoader.defineClass("com.jason.asm.Hello", data);
